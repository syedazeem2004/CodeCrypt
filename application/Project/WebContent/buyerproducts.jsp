						...
						<tbody>
							...
							try {
								...
								PreparedStatement pst = con.prepareStatement(
										"SELECT product.name,product.image,product.uid,product.pid,bid.bidvalue,bid.status from bid RIGHT JOIN product ON bid.pid = product.pid where bid.userid=?;");
